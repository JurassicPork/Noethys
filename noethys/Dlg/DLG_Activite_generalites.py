...
class Panel(wx.Panel):
    def __init__(self, parent, IDactivite=None, nouvelleActivite=False):
        ...
        # Code comptable
        self.staticbox_comptabilite_staticbox = wx.StaticBox(self, -1, _(u"Comptabilité"))
...
=======
        ...
        self.ctrl_validite_du.SetToolTip(wx.ToolTip(_(u"Saisissez une date de debut de validit�")))
        self.ctrl_validite_au.SetToolTip(wx.ToolTip(_(u"Saisissez ici une date de fin de validit�")))
        self.ctrl_public.SetToolTip(wx.ToolTip(_(u"Cochez les publics autoris�s � �tre inscrit � cette activit�")))
        self.check_limitation_inscrits.SetToolTip(wx.ToolTip(_(u"Cochez cette case pour d�finir un nombre maximal d'inscrits pour cette activit� (Utile uniquement pour les activit�s � dur�e limit�e)")))
        self.ctrl_limitation_inscrits.SetToolTip(wx.ToolTip(_(u"Saisissez le nombre maximal d'inscrits de cette activit� (Utile uniquement pour les activit�s � dur�e limit�e)")))
        self.ctrl_code_comptable.SetToolTip(wx.ToolTip(_(u"Saisissez un code comptable si vous souhaitez utiliser l'export des �critures comptables vers des logiciels de compta")))
        self.ctrl_code_produit_local.SetToolTip(wx.ToolTip(_(u"Saisissez un code produit local si vous souhaitez utiliser l'export vers les logiciels de comptabilit� publique")))
        ...
        self.ctrl_code_analytique.SetToolTip(wx.ToolTip(_(u"Saisissez un code analytique si vous souhaitez utiliser l'export vers les logiciels de comptabilit�")))
...
>>>>>>> ff5d149acb272662379069f7d1c9a97262e6fc88
    ...
    def Importation(self):
        ...
        if resultat == 0:
            dlg = wx.MessageDialog(self, _(u"Il semble y avoir une erreur dans la derni�re mise � niveau de la base de donn�es. Essayez ceci depuis le Noethys de l'ordinateur qui h�berge les donn�es : Menu Outils > Utilitaires admin > Proc�dures. Saisissez le code A9281 et validez."), _(u"Erreur"), wx.OK | wx.ICON_EXCLAMATION)
            dlg.ShowModal()
            dlg.Destroy()
            return False
